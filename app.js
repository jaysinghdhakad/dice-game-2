...
function rollthedice() {
  const rollDiceOutCome = generateRnadomNum1to6();
  setValueOnDom(rollDiceOutCome, diceOutput);
  addTheScore(rollDiceOutCome);
  checkScore();
  rollDiceOutCome !== 6 ? (turn = turn === 0 ? 1 : 0) : turn;
  setTurn(turn);
}
...
function generateRnadomNum1to6() {
